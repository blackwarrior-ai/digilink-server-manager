...
class Test extends Notification implements ShouldQueue
{
    ...
    public function toDiscord(): DiscordMessage
    {
        $message = new DiscordMessage(
            ...
            description: 'This is a test Discord notification from Black. :cross_mark: :warning: :information_source:',
    ...
    {
        return [
            'message' => 'Coolify: This is a test Telegram notification from Black.',
            'buttons' => [
                [
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            message: 'This is a test Pushover notification from Black.',
            buttons: [
                [
                    'text' => 'Go to your dashboard',
                    'url' => base_url(),
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            ...
            description: 'This is a test Slack notification from Black.'
        );
    }
    ...
    public function toWebhook(): array
    {
        return [
            'success' => true,
            'message' => 'This is a test webhook notification from Black.',
            'event' => 'test',
            'url' => base_url(),
        ];
    }
