    ...
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            <form wire:submit='submit' class="flex flex-col">
                ...
                <div class="pb-4">General configuration for your Black instance.</div>
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-wrap items-end gap-2">
                        <div class="flex gap-2 md:flex-row flex-col w-full">
                            ...
                            <x-forms.input canGate="update" :canResource="$settings" id="instance_name" label="Name" placeholder="Black"
                                helper="Custom name for your Black instance, shown in the URL." />
                            ...
                            init() {
                                ...
                                <div class="flex items-center mb-1">
                                    <label for="instance_timezone">Instance
                                        Timezone</label>
                                    <x-helper class="ml-2"
                                        helper="Timezone for the Black instance. This is used for the update check and automatic update frequency." />
                                </div>
                                <div class="relative">
                        ...
                        <div class="flex gap-2 md:flex-row flex-col w-full">
                            <x-forms.input canGate="update" :canResource="$settings" id="public_ipv4" type="password" label="Instance's Public IPv4"
                                helper="Enter the IPv4 address of the instance.<br><br>It is useful if you have several IPv4 addresses and Black could not detect the correct one."
                            ...
                            <x-forms.input canGate="update" :canResource="$settings" id="public_ipv6" type="password" label="Instance's Public IPv6"
                                helper="Enter the IPv6 address of the instance.<br><br>It is useful if you have several IPv6 addresses and Black could not detect the correct one."
            ...
            <x-domain-conflict-modal :conflicts="$domainConflicts" :showModal="$showDomainConflictModal"
                ...
                <x-slot:consequences>
                    <ul class="mt-2 ml-4 list-disc">
                        <li>The Black instance domain will conflict with existing resources</li>
                        <li>SSL certificates might not work correctly</li>
                        <li>Routing behavior will be unpredictable</li>
                        <li>You may not be able to access the Black dashboard properly</li>
                    </ul>
                </x-slot:consequences>
