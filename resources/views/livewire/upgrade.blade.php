                                ...
                                <div class="space-y-4">
                                    ...
                                    <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                        ...
                                        <a class="font-medium underline dark:text-white hover:text-neutral-800 dark:hover:text-neutral-300"
                                            href="https://black/docs/upgrade" target="_blank">upgrade guide</a> or the
        ...
        Alpine.data('upgradeModal', (config) => ({
            ...
            simulateUpgrade() {
                ...
                const steps = [
                    ...
                    { step: 3, status: '[DEV] Pulling Black image...' },
            ...
            getReviveStatusMessage(elapsedMinutes, attempts) {
                if (elapsedMinutes === 0) {
                    return `Waiting for Black to come back online... (attempt ${attempts})`;
                } else if (elapsedMinutes < 2) {
                    return `Waiting for Black to come back online... (${elapsedMinutes} minute${elapsedMinutes !== 1 ? 's' : ''} elapsed)`;
                ...
                this.checkUpgradeStatusInterval = setInterval(async () => {
                    try {
                        ...
                        if (!this.serviceDown) {
                            ...
                            this.currentStep = 4;
                            this.currentStatus = 'Black is restarting with the new version...';
                            if (this.checkUpgradeStatusInterval) {
                                clearInterval(this.checkUpgradeStatusInterval);
                                this.checkUpgradeStatusInterval = null;
                            }
