        ...
        <div class="w-full">
            @if ($resourceType === 'application')
                <x-slot:title>
                    ...
                    {{ data_get_str($serviceApplication, 'name')->limit(10) }} | Black
                </x-slot>
                        ...
                        <div class="flex flex-col gap-2">
                            @if ($requiredPort && !$serviceApplication->serviceType()?->contains(str($serviceApplication->image)->before(':')))
                                <x-callout type="info" title="Required Port: {{ $requiredPort }}" class="mb-2">
                                    ...
                                    <br><br>
                                    <strong>Example:</strong> https://app.black:{{ $requiredPort }},https://www.app.black:{{ $requiredPort }}
                                </x-callout>
                            @endif
            ...
            @elseif ($resourceType === 'database')
                <x-slot:title>
                    {{ data_get_str($service, 'name')->limit(10) }} >
                    {{ data_get_str($serviceDatabase, 'name')->limit(10) }} | Black
                </x-slot>
