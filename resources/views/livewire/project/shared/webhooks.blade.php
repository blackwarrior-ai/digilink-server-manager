<div class="flex flex-col gap-2">
    <div class="flex items-center gap-2">
        <h2>Webhooks</h2>
        <x-helper
            helper="For more details goto our <a class='underline dark:text-white' href='https://black/docs/api-reference/authorization' target='_blank'>docs</a>." />
    </div>
    <div>
        <x-forms.input readonly
            helper="See details in our <a target='_blank' class='underline dark:text-white' href='https://black/docs/api-reference/authorization'>documentation</a>."
