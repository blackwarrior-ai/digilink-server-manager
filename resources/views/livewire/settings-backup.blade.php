<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for Black instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your Black instance, you first need to add a database resource
                    into Black.
                    <x-forms.button class="mt-2" wire:click="addBlackDatabase">Configure Backup</x-forms.button>
                @endif
            @else
