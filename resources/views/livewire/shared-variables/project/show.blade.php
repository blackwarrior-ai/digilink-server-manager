<div>
    ...
    <div class="flex flex-wrap gap-1 subtitle">
        ...
        <x-helper
            helper="More info <a class='underline dark:text-white' href='https://black/docs/knowledge-base/environment-variables#shared-variables' target='_blank'>here</a>."></x-helper>
    </div>
    @if ($view === 'normal')
