<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Sentinel | Black
    </x-slot>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    @if ($server->isSentinelEnabled())
                        ...
                        <x-forms.input canGate="update" :canResource="$server" id="sentinelCustomUrl" required
                            label="Black URL"
                            helper="URL to your Black instance. If it is empty that means you do not have a FQDN set for your Black instance." />
