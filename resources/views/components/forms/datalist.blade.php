        ...
        <div x-data="{
            ...
            <div @click="$refs.searchInput.focus()" x-data="{ focused: false }" @focusin="focused = true" @focusout="focused = false"
                ...
                :style="(() => {
                    ...
                    const accent = isDark ? '#fcd452' : '#F46653';
    ...
    @else
            ...
            isDefaultValue() {
                ...
                <div @click="openDropdown()" x-data="{ focused: false }" @focusin="focused = true" @focusout="focused = false"
                    ...
                    :class="{
                    'opacity-50': {{ $disabled ? 'true' : 'false' }}
                }" wire:loading.class="opacity-50" wire:dirty.class="[box-shadow:inset_4px_0_0_#F46653,inset_0_0_0_2px_#e5e5e5] dark:[box-shadow:inset_4px_0_0_#fcd452,inset_0_0_0_2px_#242424]">
